// Built-in design-style presets = the source public catalog, ported VERBATIM from
// router.chatcut.io/public-api/design-styles/catalog (all 24, real ids/names/
// colors/fonts/styleGuide). Roles are free-form exactly as the source ships them.
