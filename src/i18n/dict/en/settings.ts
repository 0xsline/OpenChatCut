...
export default {
  ...
  '兼容 OpenAI 接口规范的自建服务或中转。先测试连接，成功后可从接口返回的模型中选择。': 'Connect a self-hosted or relay service that follows the OpenAI API format. Test it first, then choose from the returned models.',
