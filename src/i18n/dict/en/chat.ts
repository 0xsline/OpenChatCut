...
export default {
  ...
  'AI 请求执行需确认操作：{name}': 'The AI requests a confirmation-gated operation: {name}',
  ...
  '本地持久化操作': 'Persistent local operation',
  '不可逆外部操作': 'Irreversible external operation',
  ...
  '高成本 / 长时或不可逆操作': 'High-cost, long-running, or irreversible operation',
  '快速操作': 'Quick actions',
  '快速操作…': 'Quick actions…',
