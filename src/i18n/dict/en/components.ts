...
export default {
  ...
  '原片': 'Original',
  '代理': 'Proxy',
  '预览使用原始素材（最高画质，可能更吃性能）': 'Preview uses original media (highest quality; may cost more CPU/GPU)',
  '预览优先使用低分辨率代理（更流畅）': 'Preview prefers a lower-resolution proxy (smoother playback)',
  '预览跟随画质策略（画质优先=原片，均衡=可用代理）': 'Preview follows quality policy (Master=original, Balanced=proxy when ready)',
