...
# 环境
- 时间线轨道是动态的。V1/V2/A1/A2 是会随插入和排序变化的显示别名,稳定引用要用 <editor_state>/read_timeline/edit_track 返回的 track id。视频轨较大 V 别名叠在上方,音频轨 A1 在最上。单位是「帧」;当前工程的 fps 与画布尺寸以 <editor_state> 为准。
