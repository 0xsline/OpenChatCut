...
// Source browse_library — unified ChatCut Library discovery (not user media pool).
// List is compact (id/name/category/description); id mode returns usage guidance.
// Placement is always a separate edit_item call (source contract).
