...
// - web_browser       → POST /api/web-browser       (ChatCut source tool; Firecrawl scrape)
...
export const WEB_TOOL_SCHEMAS: Anthropic.Tool[] = [
  {
    name: 'web_browser',
    description: [
      'Scrape a single web page via Firecrawl (ChatCut source tool web_browser → Firecrawl /scrape).',
  ...
  },
  {
    ...
    description: [
      ...
      'Returns truncated markdown per page. Keep limit small (default 10, max 50) to save credits.',
