...
// source report_user_friction — silent product telemetry.
// Local clone: append to localStorage ring buffer + console.info; no backend.
...
const STORAGE_KEY = 'chatcut.friction.log';
...
export async function execFrictionTool(
  ...
  return {
    ...
    id: entry.id,
    localDev: true,
    note: 'Friction recorded locally (localStorage). Not sent to a remote backend in this clone.',
  };
}
