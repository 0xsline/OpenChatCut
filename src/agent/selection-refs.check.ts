// Pure-logic checks for selection-mode references (source agent-chat bundle
...
// word→ms / word→frame mapping (keptSegments, 护城河③). Run:
...
// ── prompt tokens (source XM: @t / @r / @q / @[ / plain @name) ──────────────
...
// ── itemsInRegion (source jh: visual, visible, at-frame, intersecting) ───────
