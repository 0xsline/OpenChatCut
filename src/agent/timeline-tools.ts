...
// manage_timelines — faithful to the source tool (harness/mcp-tools-schema.md:634-666,
// 复刻规格-Agent工具与后端.md:119-122): ONE action-based tool, not separate
// create/switch tools. Mutating actions flow through propose→apply via the
// project-level draft (jR/YP whitelist in source); list/switch behave directly.
// Deviation noted: source `projectId` (external-MCP session targeting) omitted —
// we always operate on the open project.
