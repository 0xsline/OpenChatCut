...
/** User-determined guard card. allow-scope = remember authorization (scope is determined by skill, see rememberSkillAllowed). */
...
/** Whether the generation skill has been remembered and authorized in this project (the guard will release it directly before execution). */
