...
// read_script / apply_script — the Script system (source's most unique
// interaction, 护城河③): serialize the timeline to segment-id-coded Markdown,
// the agent edits the TEXT, apply diffs it back to deterministic operations.
// We implement the source's "no-workspace" host mode (mcp-tools-schema.md:899):
