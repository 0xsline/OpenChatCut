...
const EXPECTED = [
  'asset-import', 'chatcut-plugin-basics', 'create-motion-graphics', 'export', 'image-gen',
...
console.log(`plugin-skills.check: ok (${slugs.length} 技能逐字搬运 / frontmatter 三形态 / references 齐)`);
