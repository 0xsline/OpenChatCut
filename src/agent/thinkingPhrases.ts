// The playful film-crew "thinking…" phrases ChatCut shows while the agent runs
// (lifted verbatim from its agent-chat bundle's en/zh mode list). We cycle one
// per running turn instead of a plain "思考中…", faithful to the source.
