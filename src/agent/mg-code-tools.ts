...
// source create_motion_graphic_from_code — register inline MG JSX as a pool asset.
...
export const MG_CODE_TOOL_SCHEMAS: Anthropic.Tool[] = [
  {
    ...
    description: [
      'Create a new Motion Graphic asset from inline React/JSX code (source create_motion_graphic_from_code).',
