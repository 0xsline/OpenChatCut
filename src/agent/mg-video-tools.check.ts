// Runnable source-contract check: `npx tsx src/agent/mg-video-tools.check.ts`.
// Covers register_converted_video's source schema (required=['mgAssetId'];
...
// ── schema parity: required flipped to ['mgAssetId']; renderId + outputUrl present ──
{
