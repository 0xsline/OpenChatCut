// Pure YAML-frontmatter extractor for the plugin SKILL.md files (source: ChatCut
// agent-plugin). Handles `name` (plain slug), `description` in all three shapes the
// source uses — plain single line, double-quoted, and a `|` block scalar — and returns
