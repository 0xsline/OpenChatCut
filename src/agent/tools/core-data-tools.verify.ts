...
const doc = docFromTimeline({
  ...
  items: [{ id: 'audio', track: 'A1', startFrame: 0, durationInFrames: 60, name: 'audio', kind: 'audio', src: '/media/a.mp3', sourceAssetId: 'asset-a', volume: 0.7, fadeInFrames: 2, fadeOutFrames: 5, keyframes: { volume: [{ frame: 0, value: 1, easing: 'easeOut' }] } }],
});
doc.assets.push({ id: 'asset-a', name: 'audio', kind: 'audio', src: '/media/a.mp3', durationInFrames: 60 });
