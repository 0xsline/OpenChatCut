...
export const GENERATE_TOOL_SCHEMAS: AgentToolSchema[] = [
  ...
  {
    name: 'submit_music',
    description: 'Submit a Mureka, MiniMax, or Atlas Cloud music job. Mureka supports instrumental, lyrics song, prompt song, soundtrack, and track/stem modes with up to 3 results. MiniMax supports text-to-music and cover. Atlas Cloud supports text-to-music through its asynchronous audio API. Results are saved to the media pool.',
    input_schema: {
      type: 'object',
      properties: {
        ...
        provider: { type: 'string', enum: ['mureka', 'minimax', 'atlas'], description: 'Defaults to mureka.' },
        mode: { type: 'string', enum: ['instrumental', 'song', 'prompt-song', 'soundtrack', 'track', 't2m', 'cover'], description: 'Mureka: instrumental/song/prompt-song/soundtrack/track. MiniMax: t2m/cover. Atlas Cloud: t2m.' },
