// Source ChatCut default keyboard preset (live-shortcuts.json / shortcut-dispatcher).
// 54 actions. Labels are English source; UI can show zh via labelZh.
...
export interface ShortcutAction {
  ...
  labelZh: string;
  group: ShortcutGroup;
  /** Human bindings as in source, e.g. "Mod + Alt + V / Mod + Shift + B" */
  keys: string;
...
/** Canonical 54 actions — source of truth for help UI + matcher. */
