...
// ── llmHeaders:按协议注入上游鉴权(google=x-goog-api-key;anthropic=x-api-key;其余 Bearer) ──
{
  ...
  assert.deepEqual(llmHeaders(reqFor('anthropic')), { 'x-api-key': 'ak-1', authorization: 'Bearer ak-1', 'anthropic-version': '2023-06-01' }, 'anthropic dual-auth (x-api-key + Bearer, for 9Router/Maxplus gateways)');
